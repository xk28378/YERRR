function [Time,VQ1c,VC1B] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIME,VQ1C,VC1B] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [TIME,VQ1C,VC1B] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [Time,VQ1c,VC1B] = importfile('projecttxt.txt',2, 154);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/05/10 15:14:58
