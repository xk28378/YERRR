...
HD_PWD='C:/Users/nehmy/OneDrive/Desktop/415 Hws and Projects/HW4/HW4_Blake_Wishard/HW4_Blake_Wishard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ISA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ISA.tcl
