...
HD_PWD='C:/Users/nehmy/OneDrive/Desktop/415 Hws and Projects/HW4/HW4_Blake_Wishard/HW4_Blake_Wishard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ISA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ISA.tcl -notrace
