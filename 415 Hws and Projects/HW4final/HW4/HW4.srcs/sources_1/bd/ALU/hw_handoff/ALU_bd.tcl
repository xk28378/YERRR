...
proc create_root_design { parentCell } {
  ...
  set MOD_OUT [ create_bd_port -dir O -from 15 -to 0 -type data MOD_OUT ]
  ...
  # Create instance: mod16_0, and set properties
  set block_name mod16
  set block_cell_name mod16_0
  if { [catch {set mod16_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mod16_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins and16_0/A] [get_bd_pins c_addsub_0/A] [get_bd_pins c_addsub_1/A] [get_bd_pins div_gen_0/s_axis_divisor_tdata] [get_bd_pins mod16_0/A] [get_bd_pins mult_gen_0/A] [get_bd_pins or16_0/A] [get_bd_pins xor16_0/A]
  connect_bd_net -net BVALID_1 [get_bd_ports BVALID] [get_bd_pins div_gen_0/s_axis_dividend_tvalid]
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins and16_0/B] [get_bd_pins c_addsub_0/B] [get_bd_pins c_addsub_1/B] [get_bd_pins div_gen_0/s_axis_dividend_tdata] [get_bd_pins mod16_0/B] [get_bd_pins mult_gen_0/B] [get_bd_pins or16_0/B] [get_bd_pins xor16_0/B]
  ...
  connect_bd_net -net mod16_0_Y [get_bd_ports MOD_OUT] [get_bd_pins mod16_0/Y]
