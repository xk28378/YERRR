...
HD_PWD='C:/Users/nehmy/OneDrive/Desktop/HW4/HW4/HW4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ISA_decode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ISA_decode.tcl -notrace
