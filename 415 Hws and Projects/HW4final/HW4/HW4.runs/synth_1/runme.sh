...
HD_PWD='C:/Users/nehmy/OneDrive/Desktop/415 Hws and Projects/HW4Phase1 - 1/HW4Phase1/HW4/HW4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ISA_decode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ISA_decode.tcl
